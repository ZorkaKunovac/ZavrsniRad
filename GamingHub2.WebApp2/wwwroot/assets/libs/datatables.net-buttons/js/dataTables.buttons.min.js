...
*/
(function(e) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(B) { return e(B, window, document) }) : "object" === typeof exports ? module.exports = function(B, y) {
        B || (B = window);
        y && y.fn.dataTable || (y = require("datatables.net")(B, y).$);
        return e(y, B, B.document)
    } : e(jQuery, window, document)
})(function(e, B, y, q) {
    function I(a, b, c) { e.fn.animate ? a.stop().fadeIn(b, c) : (a.css("display", "block"), c && c.call(a)) }

    function J(a, b, c) { e.fn.animate ? a.stop().fadeOut(b, c) : (a.css("display", "none"), c && c.call(a)) }
    ...
    var t = e.fn.dataTable,
        ...
        z = t.ext.buttons,
        v = function(a, b) {
            if (!(this instanceof v)) return function(c) { return (new v(c, a)).container() };
    ...
    e.extend(v.prototype, {
        ...
        text: function(a, b) {
            ...
            var d = this.s.dt,
                h = e(c.node),
                g = function(l) { return "function" === typeof l ? l(d, h, c.conf) : l };
        ...
        _constructor: function() {
            ...
            b.on("destroy", function(l, k) { k === c && a.destroy() });
            e("body").on("keyup." + this.s.namespace, function(l) { if (!y.activeElement || y.activeElement === y.body) { var k = String.fromCharCode(l.keyCode).toLowerCase(); - 1 !== a.s.listenKeys.toLowerCase().indexOf(k) && a._keypress(k, l) } })
        },
        _addKey: function(a) {
        ...
        _expandButton: function(a, b, c, d, h, g, l) {
            ...
            for (var r = p.length; c < r; c++) {
                ...
                if (f)
                    if (b = f.config !== q && f.config.split ? !0 : !1, Array.isArray(f)) this._expandButton(a,
                        f, m !== q && m.conf !== q ? m.conf.split : q, d, l !== q && l.split !== q, g, l);
                    else {
                        ...
                        if (m) {
                            ...
                            if (m.conf.buttons || m.conf.split) {
                                ...
                                if (m.conf.split)
                                    for (var u = 0; u < m.conf.split.length; u++) "object" === typeof m.conf.split[u] && (m.conf.split[c].parent = l, m.conf.split[u].collectionLayout === q &&
                                        (m.conf.split[u].collectionLayout = m.conf.collectionLayout), m.conf.split[u].dropup === q && (m.conf.split[u].dropup = m.conf.dropup), m.conf.split[u].fade === q && (m.conf.split[u].fade = m.conf.fade));
        ...
        _buildButton: function(a, b, c, d) {
            var h = this.c.dom.button,
                ...
                p = this.s.dt,
                r = function(w) { return "function" === typeof w ? w(p, f, a) : w };
            ...
            if (a.hasOwnProperty("html")) var f = e(a.html);
                ...
                f = e("<" + l + "/>").addClass(h.className).addClass(d ? this.c.dom.splitDropdownButton.className : "").attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(w) {
                    ...
                    u && f.trigger("blur")
                }).on("keyup.dtb", function(w) { 13 === w.keyCode && !f.hasClass(h.disabled) && a.action && m(w, p, f, a) });
            ...
            if (c) {
                ...
                x.append(f);
                var D = e.extend(a, { text: this.c.dom.splitDropdown.text, className: this.c.dom.splitDropdown.className, attr: { "aria-haspopup": !0, "aria-expanded": !1 }, align: this.c.dom.splitDropdown.align, splitAlignClass: this.c.dom.splitDropdown.splitAlignClass });
                this._addKey(D);
                var G = function(w, A, C, F) {
                    ...
                    E = e('<button class="' + this.c.dom.splitDropdown.className + ' dt-button"><span class="dt-btn-split-drop-arrow">' + this.c.dom.splitDropdown.text + "</span></button>").on("click.dtb", function(w) {
                        ...
                        u && E.trigger("blur")
                    }).on("keyup.dtb", function(w) { 13 === w.keyCode && !E.hasClass(h.disabled) && D.action && G(w, p, E, D) });
        ...
        _nodeToButton: function(a, b) { b || (b = this.s.buttons); for (var c = 0, d = b.length; c < d; c++) { if (b[c].node === a) return b[c]; if (b[c].buttons.length) { var h = this._nodeToButton(a, b[c].buttons); if (h) return h } } },
            ...
            var b = this.s.dt,
                c, d = function(k) {
                    for (var n = 0; !e.isPlainObject(k) && !Array.isArray(k);) {
                        if (k === q) return;
                        if ("function" === typeof k) { if (k = k(b, a), !k) return !1 } else if ("string" === typeof k) {
        ...
        _popover: function(a, b, c) {
            var d = this.c,
                h = e.extend({ align: "button-left", autoClose: !1, background: !0, backgroundClassName: "dt-button-background", contentClassName: d.dom.collection.className, collectionLayout: "", collectionTitle: "", dropup: !1, fade: 400, popoverTitle: "", rightAlignClassName: "dt-button-right", splitRightAlignClassName: "dt-button-split-right", splitLeftAlignClassName: "dt-button-split-left", tag: d.dom.collection.tag }, c),
                g = b.node(),
                l = function() {
            ...
            if ("absolute" ===
                ...
                if (c.hasClass(h.rightAlignClassName) || c.hasClass(h.leftAlignClassName) || c.hasClass(h.splitAlignClass) || "dt-container" === h.align) {
                    ...
                    else if (c.hasClass(h.splitRightAlignClassName)) f = u - p, d > n + f && (d -= n + f, k -= p +
                        f, f = d > k ? f + k : f + d);
                    else if (c.hasClass(h.splitLeftAlignClassName)) { if (f = m - n, k < p + f || d > n + f) d -= n + f, k -= p + f, f = d > k ? f + k : f + d } else f = d - n, k < p + f && (d -= n + f, k -= p + f, f = d > k ? f + k : f + d)
            ...
            e("body").on("click.dtb-collection",
                ...
                }).on("keyup.dtb-collection", function(x) { 27 === x.keyCode && l() });
            h.autoClose && setTimeout(function() { b.on("buttons-action.b-internal", function(x, D, G, E) { E[0] !== g[0] && l() }) }, 0);
    ...
    v.instanceSelector = function(a, b) {
        if (a === q || null === a) return e.map(b, function(g) { return g.inst });
        var c = [],
            d = e.map(b, function(g) { return g.name }),
            h = function(g) {
                if (Array.isArray(g))
    ...
    v.buttonSelector = function(a, b) {
        for (var c = [], d = function(k, n, p) {
                for (var r, f, m = 0, u = n.length; m < u; m++)
                    if (r = n[m]) f = p !== q ? p + m : m + "", k.push({ node: r.node, name: r.conf.name, idx: f }), r.buttons && d(k, r.buttons, f + "-")
            }, h = function(k, n) {
                var p, r = [];
                d(r, n.s.buttons);
                var f = e.map(r, function(m) { return m.node });
                if (Array.isArray(k) || k instanceof e)
                    for (f = 0, p = k.length; f < p; f++) h(k[f], n);
                else if (null === k || k === q || "*" === k)
                    for (f = 0, p = r.length; f < p; f++) c.push({ inst: n, node: r[f].node });
                else if ("number" === typeof k) c.push({ inst: n, node: n.s.buttons[k].node });
                else if ("string" ===
                    typeof k)
                    if (-1 !== k.indexOf(","))
                        for (r = k.split(","), f = 0, p = r.length; f < p; f++) h(r[f].trim(), n);
                    else if (k.match(/^\d+(\-\d+)*$/)) f = e.map(r, function(m) { return m.idx }), c.push({ inst: n, node: r[e.inArray(k, f)].node });
                else if (-1 !== k.indexOf(":name"))
                    for (k = k.replace(":name", ""), f = 0, p = r.length; f < p; f++) r[f].name === k && c.push({ inst: n, node: r[f].node });
                else e(f).filter(k).each(function() { c.push({ inst: n, node: this }) });
    ...
    e.extend(z, {
        ...
        copy: function(a, b) { if (z.copyHtml5) return "copyHtml5" },
        csv: function(a, b) { if (z.csvHtml5 && z.csvHtml5.available(a, b)) return "csvHtml5" },
        excel: function(a, b) { if (z.excelHtml5 && z.excelHtml5.available(a, b)) return "excelHtml5" },
        pdf: function(a, b) { if (z.pdfHtml5 && z.pdfHtml5.available(a, b)) return "pdfHtml5" },
        pageLength: function(a) {
            ...
            return {
                extend: "collection",
                text: function(g) { return g.i18n("buttons.pageLength", { "-1": "Show all rows", _: "Show %d rows" }, g.page.len()) },
                ...
                buttons: e.map(b, function(g, l) {
                    return {
                        ...
                        action: function(k, n) { n.page.len(g).draw() },
                        init: function(k, n, p) {
                            var r = this;
                            n = function() { r.active(k.page.len() === g) };
                            k.on("length.dt" +
                                p.namespace, n);
                            n()
                        },
                ...
                init: function(g, l, k) {
                    var n = this;
                    g.on("length.dt" + k.namespace, function() { n.text(k.text) })
                },
                destroy: function(g, l, k) { g.off("length.dt" + k.namespace) }
            }
        }
    });
    t.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(!0, "table", function(d) { if (d._buttons) return v.buttonSelector(v.instanceSelector(a, d._buttons), b) }, !0);
        c._groupSelector = a;
        return c
    });
    ...
    t.Api.registerPlural("buttons().active()", "button().active()", function(a) { return a === q ? this.map(function(b) { return b.inst.active(b.node) }) : this.each(function(b) { b.inst.active(b.node, a) }) });
    t.Api.registerPlural("buttons().action()", "button().action()", function(a) { return a === q ? this.map(function(b) { return b.inst.action(b.node) }) : this.each(function(b) { b.inst.action(b.node, a) }) });
    t.Api.registerPlural("buttons().collectionRebuild()", "button().collectionRebuild()",
        function(a) { return this.each(function(b) { b.inst.collectionRebuild(b.node, a) }) });
    t.Api.register(["buttons().enable()", "button().enable()"], function(a) { return this.each(function(b) { b.inst.enable(b.node, a) }) });
    t.Api.register(["buttons().disable()", "button().disable()"], function() { return this.each(function(a) { a.inst.disable(a.node) }) });
    ...
    t.Api.registerPlural("buttons().processing()",
        "button().processing()",
        function(a) { return a === q ? this.map(function(b) { return b.inst.processing(b.node) }) : this.each(function(b) { b.inst.processing(b.node, a) }) });
    t.Api.registerPlural("buttons().text()", "button().text()", function(a) { return a === q ? this.map(function(b) { return b.inst.text(b.node) }) : this.each(function(b) { b.inst.text(b.node, a) }) });
    ...
    t.Api.register("button().popover()",
        function(a, b) { return this.map(function(c) { return c.inst._popover(a, this.button(this[0].node), b) }) });
    t.Api.register("buttons().containers()", function() {
        var a = e(),
            b = this._groupSelector;
        this.iterator(!0, "table", function(c) { if (c._buttons) { c = v.instanceSelector(b, c._buttons); for (var d = 0, h = c.length; d < h; d++) a = a.add(c[d].container()) } });
        return a
    });
    ...
    t.Api.register("buttons.info()", function(a, b, c) {
        ...
        if (!1 === a) return this.off("destroy.btn-info"), J(e("#datatables_buttons_info"),
            400,
            function() { e(this).remove() }), clearTimeout(H), H = null, this;
        H && clearTimeout(H);
        ...
        c !== q && 0 !== c && (H = setTimeout(function() { d.buttons.info(!1) }, c));
        this.on("destroy.btn-info", function() { d.buttons.info(!1) });
        return this
    });
    t.Api.register("buttons.exportData()",
        function(a) { if (this.context.length) return Q(new t.Api(this.context[0]), a) });
    ...
    var K = function(a) { return null === a || a === q ? null : "function" === typeof a ? a() : a },
        N = function(a, b, c) {
            b = K(b);
        ...
        Q = function(a, b) {
            var c = e.extend(!0, {}, {
                ...
                decodeEntities: !0,
                trim: !0,
                format: { header: function(u) { return v.stripData(u, c) }, footer: function(u) { return v.stripData(u, c) }, body: function(u) { return v.stripData(u, c) } },
                customizeData: null
            }, b);
            b = a.columns(c.columns).indexes().map(function(u) { var x = a.column(u).header(); return c.format.header(x.innerHTML, u, x) }).toArray();
    ...
    e.fn.DataTable.Buttons = v;
    e(y).on("init.dt plugin-init.dt", function(a, b) { "dt" === a.namespace && (a = b.oInit.buttons || t.defaults.buttons) && !b._buttons && (new v(b, a)).container() });
