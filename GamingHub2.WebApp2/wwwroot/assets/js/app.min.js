! function(l) {
    ...
    t.prototype._reset = function() { this.body.removeAttr("data-sidebar-color"), this.body.removeAttr("data-sidebar-size"), this.body.removeAttr("data-sidebar-showuser") }, t.prototype.changeColor = function(t) { this.body.attr("data-sidebar-color", t), this.parent.updateConfig("sidebar", { color: t }) }, t.prototype.changeSize = function(t) { this.body.attr("data-sidebar-size", t), this.parent.updateConfig("sidebar", { size: t }) }, t.prototype.showUser = function(t) { this.body.attr("data-sidebar-showuser", t), this.parent.updateConfig("sidebar", { showuser: t }) }, t.prototype.initMenu = function() {
        ...
        if (l("#two-col-sidenav-main").length) {
            ...
            }), o.on("click", function(t) { var e = l(l(this).attr("href")); return !e.length || (t.preventDefault(), o.removeClass("active"), l(this).addClass("active"), s.removeClass("d-block"), e.addClass("d-block"), l.LayoutThemeApp.leftSidebar.changeSize("default"), !1) });
            var d = window.location.href;
            o.each(function() { this.href === d && l(this).addClass("active") }), l("#two-col-menu a").each(function() {
                if (this.href == d) {
                    l(this).addClass("active"), l(this).parent().addClass("menuitem-active"), l(this).parent().parent().parent().addClass("show"), l(this).parent().parent().parent().parent().addClass("menuitem-active");
                    ...
                    l("#two-col-sidenav-main .nav-link").each(function() { l(this).attr("href") === a && (n = l(this)) }), n && n.trigger("click")
                }
            })
        }
    }, t.prototype.initLayout = function() { 768 <= this.window.width() && this.window.width() <= 1028 || this.body.data("keep-enlarged") ? this.changeSize("condensed") : this.changeSize("default") }, t.prototype.init = function() {
        var e = this;
        this.initMenu(), this.initLayout(), this.window.on("resize", function(t) { t.preventDefault(), e.initLayout() })
...
function(a) {
    ...
    t.prototype.initMenu = function() {
        a("#top-search").on("click", function(t) { a("#search-dropdown").addClass("d-block") }), a(".topbar-dropdown").on("show.bs.dropdown", function() { a("#search-dropdown").removeClass("d-block") }), a(".navbar-nav a").each(function() {
            var t = window.location.href.split(/[?#]/)[0];
            if (this.href == t) {
        ...
        }), a(".navbar-toggle").on("click", function(t) { a(this).toggleClass("open"), a("#navigation").slideToggle(400) });
        ...
        t.forEach(function(i) {
            ...
            }), i.addEventListener("hide.bs.dropdown", function(t) { n && (t.preventDefault(), t.stopPropagation(), n = !1) })
        })
    }, t.prototype.changeColor = function(t) { this.body.attr("data-topbar-color", t), this.parent.updateConfig("topbar", { color: t }) }, t.prototype.init = function() { this.initMenu() }, a.Topbar = new t, a.Topbar.Constructor = t
}(window.jQuery),
function(i) {
    "use strict";

    function t() { this.body = i("body"), this.window = i(window) }
...
function(a) {
    ...
    t.prototype._saveConfig = function(t) { this.config = a.extend(this.config, t) }, t.prototype.updateConfig = function(t, e) {
        ...
        var t = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}"),
            e = a.extend({}, { mode: "light", width: "fluid", menuPosition: "fixed", sidebar: { color: "light", size: "default", showuser: !1 }, topbar: { color: "dark" }, showRightSidebarOnPageLoad: !1 });
        ...
        switch (t) {
            case "dark":
                this.body.prepend(""), this.body.css({ visibility: "hidden", opacity: 0 }), this.defaultBSStyle.attr("disabled", !0), this.defaultAppStyle.attr("disabled", !0), this.darkBSStyle.attr("disabled", !1), this.darkAppStyle.attr("disabled", !1), setTimeout(function() { i.body.css({ visibility: "visible", opacity: 1 }) }, 500), this._saveConfig({ mode: t });
                break;
            default:
                this.body.css({ visibility: "hidden", opacity: 0 }), this.defaultBSStyle.attr("disabled", !1), this.defaultAppStyle.attr("disabled", !1), this.darkBSStyle.attr("disabled", !0), this.darkAppStyle.attr("disabled", !0), setTimeout(function() { i.body.css({ visibility: "visible", opacity: 1 }) }, 500), this._saveConfig({ mode: t })
        }
        this.rightBar.selectOptionsFromConfig()
    }, t.prototype.changeLayoutWidth = function(t) {
        switch (t) {
            case "boxed":
                this.body.attr("data-layout-width", "boxed"), a.LeftSidebar.changeSize("condensed"), window.dispatchEvent(new Event("adminto.setBoxed")), this._saveConfig({ width: t });
                break;
            default:
                this.body.attr("data-layout-width", "fluid");
                var e = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}");
                a.LeftSidebar.changeSize(e && e.sidebar ? e.sidebar.size : "default"), this._saveConfig({ width: t }), window.dispatchEvent(new Event("adminto.setFluid"))
        }
        this.rightBar.selectOptionsFromConfig()
    }, t.prototype.changeMenuPositions = function(t) { this.body.attr("data-layout-menu-position", t), this._saveConfig({ menuPosition: t }) }, t.prototype.clearSavedConfig = function() { this.config = {} }, t.prototype.getConfig = function() { return this.config }, t.prototype.reset = function() { this.clearSavedConfig(), this.applyConfig() }, t.prototype.init = function() { this.leftSidebar = a.LeftSidebar, this.topbar = a.Topbar, ((this.leftSidebar.parent = this).topbar.parent = this).applyConfig() }, a.LayoutThemeApp = new t, a.LayoutThemeApp.Constructor = t
}(window.jQuery),
function(o) {
    "use strict";
    ...
    t.prototype.initTooltipPlugin = function() { o.fn.tooltip && o('[data-bs-toggle="tooltip"]').tooltip() }, t.prototype.initPopoverPlugin = function() { o.fn.popover && o('[data-bs-toggle="popover"]').popover() }, t.prototype.initToastPlugin = function() { o.fn.toast && o('[data-bs-toggle="toast"]').toast() }, t.prototype.initFormValidation = function() { o(".needs-validation").on("submit", function(t) { return o(this).addClass("was-validated"), !1 !== o(this)[0].checkValidity() || (t.preventDefault(), t.stopPropagation(), !1) }) }, t.prototype.initCounterUp = function() {
        ...
        o('[data-plugin="counterup"]').each(function(t, e) { o(this).counterUp({ delay: i, time: n }) })
        ...
        }), o('[data-plugin="peity-donut-alt"]').each(function(t, e) { o(this).peity("donut") }), o('[data-plugin="peity-line"]').each(function(t, e) { o(this).peity("line", o(this).data()) }), o('[data-plugin="peity-bar"]').each(function(t, e) {
            var i = o(this).attr("data-colors") ? o(this).attr("data-colors").split(",") : [],
                n = o(this).attr("data-width") ? o(this).attr("data-width") : 20,
                a = o(this).attr("data-height") ? o(this).attr("data-height") : 20;
            o(this).peity("bar", { fill: i, width: n, height: a })
        })
    }, t.prototype.initKnob = function() { o('[data-plugin="knob"]').each(function(t, e) { o(this).knob() }) }, t.prototype.initTippyTooltips = function() { 0 < o('[data-plugin="tippy"]').length && tippy('[data-plugin="tippy"]') }, t.prototype.initShowPassword = function() { o("[data-password]").on("click", function() { "false" == o(this).attr("data-password") ? (o(this).siblings("input").attr("type", "text"), o(this).attr("data-password", "true"), o(this).addClass("show-password")) : (o(this).siblings("input").attr("type", "password"), o(this).attr("data-password", "false"), o(this).removeClass("show-password")) }) }, t.prototype.initMultiDropdown = function() { o(".dropdown-menu a.dropdown-toggle").on("click", function(t) { return o(this).next().hasClass("show") || o(this).parents(".dropdown-menu").first().find(".show").removeClass("show"), o(this).next(".dropdown-menu").toggleClass("show"), !1 }) }, t.prototype.init = function() { this.initTooltipPlugin(), this.initPopoverPlugin(), this.initToastPlugin(), this.initFormValidation(), this.initCounterUp(), this.initPeityCharts(), this.initKnob(), this.initTippyTooltips(), this.initShowPassword(), this.initMultiDropdown() }, o.Components = new t, o.Components.Constructor = t
}(window.jQuery),
function(a) {
    "use strict";

    function t() { this.$body = a("body"), this.$portletIdentifier = ".card", this.$portletCloser = '.card a[data-toggle="remove"]', this.$portletRefresher = '.card a[data-toggle="reload"]' }
...
function(i) {
    ...
    t.prototype.initControls = function() {
        ...
        [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]')).map(function(t) { return new bootstrap.Popover(t) }), [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(t) { return new bootstrap.Tooltip(t) }), [].slice.call(document.querySelectorAll(".toast")).map(function(t) { return new bootstrap.Toast(t) });
        var e = document.getElementById("toastPlacement");
        e && document.getElementById("selectToastPlacement").addEventListener("change", function() { e.dataset.originalClass || (e.dataset.originalClass = e.className), e.className = e.dataset.originalClass + " " + this.value }), document.getElementById("app-default-stylesheet").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl"), document.getElementById("app-dark-stylesheet").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl")
