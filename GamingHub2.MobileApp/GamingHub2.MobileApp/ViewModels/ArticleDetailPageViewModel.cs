...
using Model = GamingHub2.MobileApp.Models.Story;
...
namespace GamingHub2.MobileApp.ViewModels
{
    ...
    public class ArticleDetailPageViewModel : BaseViewModel
    {
        ...
        /// </summary>
        private ObservableCollection<Recenzija> relatedStories;

        /// <summary>
        /// Gets or sets the article content list.
        /// </summary>
        private ObservableCollection<Recenzija> contentList;
        ...
        public ObservableCollection<Recenzija> RelatedStories
        {
            get
            {
        ...
        public ObservableCollection<Recenzija> ContentList
        {
            get
            {
        ...
        {
            var file = "GamingHub2.MobileApp.Data." + fileName;
        ...
        //{
        //    if (obj != null && (obj is Recenzija))
        //    {
        //        (obj as Recenzija).IsBookmarked = (obj as Recenzija).IsBookmarked ? false : true;
        //    }
